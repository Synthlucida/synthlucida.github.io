...
const APP_CACHE_NAME = 'synthlucida-app-v846';
...
self.addEventListener('fetch', (event) => {
  ...
  if (/\/(weather|progrese|denik-vozidla|tripcost|webzen|vyplata|michani-liquidu|vodovaha|vodovaha-en|vapetrack|vapetrack-en)/i.test(url.pathname)) {
    return;
  }
